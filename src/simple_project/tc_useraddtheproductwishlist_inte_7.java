...
public class tc_useraddtheproductwishlist_inte_7 {
...
//step:-click on wishlist
	...
	if (actulwhisurl.equals(wishurl)) {
		System.out.println("user able to click on wishlist");
	} else {
System.out.println("user not able to wishlist");
	}
