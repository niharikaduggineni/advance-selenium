...
public class TC_verifyuserabletoaddproducttocart_005 {
	...
	public static void main(String[] args) {
		...
		//step:-8 user search for product
		...
		System.out.println(seartitle);
		if(actualsearch.equals(seartitle)) {
			System.out.println("user able to click on search");
		}else {
			System.out.println("user not able to click on search");
		}
		 driver.findElement(By.xpath("//input[@value=\"Add to cart\"]")).click();
		String carttitle= driver.getCurrentUrl();
		System.out.println(carttitle);
		if(actualcart.equals(carttitle)) {
			System.out.println("user able to click on cart");
		}else {
			System.out.println("user not able to click on cart");
		}
		//step:-8 user quit
		driver.close();
