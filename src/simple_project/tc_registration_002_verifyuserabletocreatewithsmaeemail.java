...
public class tc_registration_002_verifyuserabletocreatewithsmaeemail {
	...
	public static void main(String[] args) {
		...
		//step:- 1 open the broswer
				...
				regibutton.click();
				String data1 = driver.findElement(By.xpath("//li[text()=\"The specified email already exists\"]")).getText();
				System.out.println(data);
